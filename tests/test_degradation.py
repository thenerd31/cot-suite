...
def test_legibility_coverage_drops_under_degradation(degrader) -> None:
    from cotsuite import metrics as _  # noqa: F401 — ensure registration
    ...
    with patch("cotsuite.autoraters.legibility_coverage.get_grader_client", return_value=grader):
