...
from cotdiv.core.registry import register_metric, register_test
...
def score_trajectory(
    ...
    Thin wrapper over the registry — see `cotdiv.core.registry.run` for the full
    surface. Returns a `ScoreResult` with per-metric `Value ± SD` and metadata.
    """
    from cotdiv.core.registry import run
