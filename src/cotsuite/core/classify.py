...
from cotsuite.core.schemas import Classification, TestResult


@dataclass(frozen=True)
class ClassificationConfig:
    computational_threshold: float = 0.2  # from memo Part 7
    rationalization_threshold: float = 0.05  # cotsuite choice; user: "< 0.05"
    cc_shap_threshold: float = 0.05  # cotsuite choice; memo says "near zero"
...
def classify(
    ...
    *,
    ...
    Args:
        ...
        config: thresholds. Defaults per memo Part 7 + cotsuite-chosen
