...
Anything in this subpackage is one of:
    ...
    (b) a cotsuite-original measurement not in any one paper
...
from cotsuite.tests.extensions.authority_bias import AUTHORITY_BIAS
from cotsuite.tests.extensions.chen_authority_cue import CHEN_AUTHORITY_CUE
from cotsuite.tests.extensions.chen_visual_pattern_cue import (
