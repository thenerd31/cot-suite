...
CLI usage:
    python -m cotmon.verify_keys                   # check all configured providers
    python -m cotmon.verify_keys --budget-check    # additionally verify Anthropic credits
    python -m cotmon.verify_keys --providers anthropic,openai
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m cotmon.verify_keys",
