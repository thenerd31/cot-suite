...
`cotmon/autoraters/prompts/emmons_zimmermann_v1.txt`. Its canonical SHA-256
...
from cotmon.core.registry import register_metric
from cotmon.core.schemas import MetricValue
